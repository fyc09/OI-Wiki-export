\documentclass[5pt,a4paper,openany]{extbook}
...
\author{OI Wiki 项目组}
\date{\today}
\titleformat{\chapter}[display]{\normalfont\large\bfseries}{第~\thechapter~章}{0.5em}{}
...
% minted settings
\setminted{fontsize=\small,breaklines,backgroundcolor=black!5!white}
\newmdenv[%
    roundcorner=5pt,
    linewidth=0pt,
    backgroundcolor=black!5!white,
...
% customize TOC
\cftsetpnumwidth{1em}
\cftsetindents{chapter}{0em}{1.2em}
\cftsetindents{section}{1.2em}{1.5em}
\cftsetindents{subsection}{2.7em}{2em}
